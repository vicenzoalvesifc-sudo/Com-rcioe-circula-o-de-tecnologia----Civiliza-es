...
No século XXI, tecnologias emergentes como inteligência artificial, biotecnologia, nanotecnologia e energias renovávei
Ao início da aula foram decididas todas as tarefas e seus respectivos responsáveis. Seguem as informações sobre as responsabilidades delegadas a cada um:

Andrius Bonatti de Andrade: Responsável pela coleta de informações e referências.
Gabriel Carlos Hardt Elias: Responsável pela idealização do site no Figma.
Heitor Medeiros Anadom: Responsável pela decisão da estilização do site(cores, formatação, etc).
Matheus Pasqualini Mello: Responsável pela idealização do site no Figma.
Matheus Rafael Oliveira: Responsável pela decisão da estilização do site(cores, formatação, etc).
...
Coordenador Matheus Pasqualini Mello & Secretário Heitor Medeiros Anadom.
—
Ausentes: Todos os integrantes estão presentes
—
...
Decidimos criar um quiz sobre os tópicos que serão abordados em nosso projeto, utilizando como referências sites como:
National Geographic
Quizur(Quizur)
Racha-Cuca()
Só História(Quiz de História) 

Andrius se comprometeu a fazer uma seleção de fontes e cores para a estilização do site.
Matheus Rafael e Heitor Medeiros começaram a catalogar as fontes e cores sugeridas para decidir quais ficam melhores na estilização do site.
O Time de Idealização e Figma começaram a fazer o wireframe do site.
Vicenzo começou uma pesquisa mais aprofundada sobre o tema principal do site.
...
Cor principal do Site: Amarelo(#ffb300)

Cores de fundo: Branco e Preto

Fonte principal: Neuton
(Anotações de Mateus Rafael)

## ATA-03 TRABALHO PI - Comércio e circulação de tecnologia - Civilizações
—
*Data: 25 de junho de 2026.*

### Assunto: Continuidade da idealização do site e distribuição de novas responsabilidades. 
